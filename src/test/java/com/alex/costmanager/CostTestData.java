...
public class CostTestData {
    ...
    public static final Cost COST4 = new Cost(COST1_ID + 3, of(2022, Month.MAY, 31, 10, 0), "Завтрак", 500);
    public static final Cost COST5 = new Cost(COST1_ID + 4, of(2022, Month.MAY, 31, 13, 0), "Обед", 1000);
    public static final Cost COST6 = new Cost(COST1_ID + 5, of(2022, Month.MAY, 31, 20, 0), "Ужин", 510);
