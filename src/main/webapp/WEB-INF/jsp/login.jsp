...
<nav class="navbar navbar-dark bg-dark py-0">
  <div class="container">
    <div class="navbar-brand"><img src="resources/images/icon-dollar.png"> <spring:message code="app.title"/></div>
...
<div class="container lead">
  &nbsp;&nbsp;&nbsp;<a href="https://github.com/AlexJelia">Java Enterprise проект</a> с
  ...
  профилем и данными (день, расходы) через UI (по AJAX) и по REST интерфейсу с базовой авторизацией.
  Возможна фильтрация данных по датам и времени, при этом цвет записи таблицы расходов зависит от того, превышает ли
  сумма
  расходов за день норму (редактируемый параметр в профиле пользователя).
